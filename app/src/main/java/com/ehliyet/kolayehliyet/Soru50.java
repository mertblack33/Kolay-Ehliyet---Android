...
public class Soru50 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soru50);
        ...
        adapter = ArrayAdapter.createFromResource(this,
                R.array.soru50, android.R.layout.simple_spinner_item);
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Soru50.this,MainActivity3.class);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String deger = sharedPreferences.getString("sec50","yok");
                if (deger.equals("0") || deger.equals("BÖLÜM SEÇ")){
                    Toast.makeText(Soru50.this,"Lütfen Bölüm Seçiniz",Toast.LENGTH_LONG).show();
                } else{
                    Intent intent = new Intent(Soru50.this,Soru50bolum.class);
                    startActivity(intent);
                }
            }
        });
    ...
    public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
        String sec = sharedPreferences.getString("sec50","0");
        ...
        sharedPreferences.edit().putString("sec50",bolum).apply();
    }
